...
**Phase 1 of 7 — Bootstrap & CI Matrix.** Tooling, CI, and lifecycle hooks are landing first; capture, storage, REST API, UI, and CLI ship in Phases 2–7.
...
Contribution guide lands in Phase 1 (`CONTRIBUTING.md`).
